...
Version 32.1
- [Fix] Fixed banding artifacts in deferred rendering path
- [Fix] Improved support for Unity 6.4

Version 32.0.1
- [Fix] Fixed near camera attenuation being applied when Start Distance is 0
